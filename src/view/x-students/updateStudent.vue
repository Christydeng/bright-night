    ...
    export default {
        ...
        methods: {
            ...
            getFormData:function(){
                ...
                global.get( api.queryStudentItem, { params:{ 'id': data.id } }, function(res){
            ...
            submitForm(formName) {
              ...
              this.$refs[formName].validate((valid) => {
                if (valid) {
                  ...
                  global.post( api.modifyStudent, this.ruleForm, null, function(res){
                      ...
                      setTimeout(()=>{
                          that.$router.push('/index/students/listStudents')
                      },2000)
                  },function(res){
